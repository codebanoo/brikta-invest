...
{
    [Area("UserProjects")]
    public class RepresentativesProjectsManagementController : ExtraUsersController
    {
        public RepresentativesProjectsManagementController(IHostEnvironment _hostEnvironment,
        ...
        public IActionResult Index()
        {
            ...
            if (ViewData["projectsVMList"] == null)
            {
                try
                {
                    serviceUrl = projectsApiUrl + "/api/ConstructionProjectsManagement/GetListOfConstructionProjectsWithRepresentativeId";

                    GetConstructionProjectWithUserIdPVM getConstructionProjectWithUserIdPVM = new GetConstructionProjectWithUserIdPVM()
                    {
                        UserId = this.userId.Value //نماینده
                    };

                    responseApiCaller = new ProjectsApiCaller(serviceUrl).GetListOfConstructionProjectsWithRepresentativeId(getConstructionProjectWithUserIdPVM);
        ...
        getConversationDataByAgreementTypeAndRecordIdPVM)
        {
            ...
            try
            {
                GetConstructionProjectFinancialDataByConstructionProjectIdPVM getConstructionProjectFinancialDataByConstructionProjectIdPVM = new GetConstructionProjectFinancialDataByConstructionProjectIdPVM
                {
                    ...
                    OwnerUserId = getConversationDataByAgreementTypeAndRecordIdPVM.OwnerUserId.Value,
                };
        ...
        [AjaxOnly]
        [HttpPost]
        public IActionResult GetSumOfPrivateCostsListForRepresantative(long constructionProjectId, string? Type = null, long? representativeId = null)
        {
            JsonResultWithRecordsObjectVM jsonResultWithRecordsObjectVM = new JsonResultWithRecordsObjectVM(new object() { });
            try
            {
                serviceUrl = projectsApiUrl + "/api/ConstructionProjectFinancialDataManagement/GetSumOfPrivateCostsListForRepresantative";
                ...
                responseApiCaller = new ProjectsApiCaller(serviceUrl).GetSumOfPrivateCostsListForRepresantative(getSumOfPrivateCostsListPVM);
                if (responseApiCaller.IsSuccessStatusCode)
                {
                    jsonResultWithRecordsObjectVM = responseApiCaller.JsonResultWithRecordsObjectVM;
                    if (jsonResultWithRecordsObjectVM != null)
                    {
                        if (jsonResultWithRecordsObjectVM.Result.Equals("OK"))
                        {
                            ...
                            List<SumOfPrivateCostsForRepresantativeVM> sumOfPrivateCostsVMList = new List<SumOfPrivateCostsForRepresantativeVM>();

                            JArray jArray = jsonResultWithRecordsObjectVM.Records;
                            sumOfPrivateCostsVMList = jArray.ToObject<List<SumOfPrivateCostsForRepresantativeVM>>();
        ...
        [AjaxOnly]
        [HttpPost]
        public IActionResult GetSumOfPublicCostsListForRepresentative(long constructionProjectId, string? Type = null, long? representativeId = null)
        {
            JsonResultWithRecordsObjectVM jsonResultWithRecordsObjectVM = new JsonResultWithRecordsObjectVM(new object() { });
            try
            {
                serviceUrl = projectsApiUrl + "/api/ConstructionProjectFinancialDataManagement/GetSumOfPublicCostsListForRepresentative";

                GetSumOfPublicCostsForRepresentativeListPVM getSumOfPublicCostsListPVM = new GetSumOfPublicCostsForRepresentativeListPVM()
                {
                    ConstructionProjectId = constructionProjectId,
                    Type = Type,
                    RepresentativeId = representativeId
                };
                responseApiCaller = new ProjectsApiCaller(serviceUrl).GetSumOfPublicCostsListForRepresentative(getSumOfPublicCostsListPVM);
                if (responseApiCaller.IsSuccessStatusCode)
                {
                    jsonResultWithRecordsObjectVM = responseApiCaller.JsonResultWithRecordsObjectVM;
                    if (jsonResultWithRecordsObjectVM != null)
                    {
                        if (jsonResultWithRecordsObjectVM.Result.Equals("OK"))
                        {
                            ...
                            List<SumOfPublicCostsRepresentativesVM> sumOfPublicCostsVMList = new List<SumOfPublicCostsRepresentativesVM>();

                            JArray jArray = jsonResultWithRecordsObjectVM.Records;
                            sumOfPublicCostsVMList = jArray.ToObject<List<SumOfPublicCostsRepresentativesVM>>();
        ...
        [AjaxOnly]
        [HttpPost]
        public IActionResult GetHierarchyOfAllProgressItemsList(long constructionProjectId, string? Type = null, long? representativeId = null)
        {
            JsonResultWithRecordsObjectVM jsonResultWithRecordsObjectVM = new JsonResultWithRecordsObjectVM(new object() { });
            try
            {
