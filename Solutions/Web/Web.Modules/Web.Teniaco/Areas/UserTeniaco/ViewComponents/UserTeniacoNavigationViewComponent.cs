...
{
    public class UserTeniacoNavigationViewComponent : ViewComponent
    {
        IHostEnvironment hostEnvironment;

        public UserTeniacoNavigationViewComponent(IHostEnvironment _hostEnvironment)
        {
        ...
        public IViewComponentResult Invoke()
        {
            ...
            return View("UserTeniacoNavigation");
        }
    }
}
