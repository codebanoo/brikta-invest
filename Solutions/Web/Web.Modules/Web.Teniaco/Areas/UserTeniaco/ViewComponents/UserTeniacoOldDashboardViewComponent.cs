...
{
    public class UserTeniacoOldDashboardViewComponent : ViewComponent
    {
        IHostEnvironment hostEnvironment;
        IActionContextAccessor actionContextAccessor;

        public UserTeniacoOldDashboardViewComponent(IHostEnvironment _hostEnvironment,
        ...
        public IViewComponentResult Invoke()
        {
            ...
            return View("UserTeniacoDashboard2");
        }
    }
}
