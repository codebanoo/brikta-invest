...
namespace Web.Teniaco.Areas.UserTeniaco.ViewComponents
{
    public class UserTeniacoOldNavigationViewComponent : ViewComponent
    {
        IHostEnvironment hostEnvironment;

        public UserTeniacoOldNavigationViewComponent(IHostEnvironment _hostEnvironment)
        {
        ...
        public IViewComponentResult Invoke()
        {
            ...
            //                {
            //                    string mainMenuFileName = role.RoleId.ToString() + "_" + level.LevelId.ToString() + "_mainmenu_" + "fa" + ".txt";
            //                    if (System.IO.File.Exists(menuFilePath + mainMenuFileName))
            //                    {
            ...
            //                    string topMenuFileName = role.RoleId.ToString() + "_" + level.LevelId.ToString() + "_topmenu_" + "fa" + ".txt";
            ...
            return View("UserTeniacoNavigation2");
        }
    }
}
