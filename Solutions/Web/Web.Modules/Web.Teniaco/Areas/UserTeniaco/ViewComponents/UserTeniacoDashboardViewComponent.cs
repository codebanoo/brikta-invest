...
{
    public class UserTeniacoDashboardViewComponent : ViewComponent
    {
        IHostEnvironment hostEnvironment;
        IActionContextAccessor actionContextAccessor;

        public UserTeniacoDashboardViewComponent(IHostEnvironment _hostEnvironment,
        ...
        public IViewComponentResult Invoke()
        {
            ...
            return View("UserTeniacoDashboard");
        }
    }
}
